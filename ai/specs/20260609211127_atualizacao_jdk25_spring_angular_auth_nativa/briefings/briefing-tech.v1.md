...
> **Figma:** ⚠️ Referência visual pendente — Figma MCP/URLs não disponíveis durante /lf-specs.
...
> Gerado por /lf-specs em 2026-06-09. URLs não fornecidas; Figma MCP não estava disponível nesta sessão.

| Tela | Rota | URL Figma | Componentes-chave | Status |
|------|------|-----------|-------------------|--------|
| Login | `/login` | — | formulário de login, Google, Facebook, erro, loading | ⚠️ Pendente |
| Registro | `/register` | — | formulário de cadastro, tipo de usuário, erro, loading | ⚠️ Pendente |
| Sessão expirada | global/interceptor | — | redirect/feedback de sessão expirada | ⚠️ Pendente |
| Header autenticado | global | — | estado autenticado, logout, usuário atual | ⚠️ Pendente |
