...
> **Figma:** ⚠️ Referência visual pendente — solicitar ao time de UX/UI para cadastro mínimo (`/register`).
> **Figma:** ⚠️ Referência visual pendente — solicitar ao time de UX/UI para social login (`/login`).
> **Figma:** ⚠️ Referência visual pendente — solicitar ao time de UX/UI para listagem sem localização (`/`, `/home`, `/publicacoes`).
> **Figma:** ⚠️ Referência visual pendente — solicitar ao time de UX/UI para listagem com localização (`/`, `/home`, `/publicacoes`).
> **Figma:** ⚠️ Referência visual pendente — solicitar ao time de UX/UI para permissão negada/localização manual.
> **Figma:** ⚠️ Referência visual pendente — solicitar ao time de UX/UI para chat mobile (`/chat`).
...
> **Figma:** ⚠️ Referência visual pendente — solicitar ao time de UX/UI para card/listagem e publicação de serviço.
...
> Gerado por /lf-specs em 2026-06-12. URLs não foram fornecidas pelo time de UX/UI.
...
|------|------|-----------|-------------------|--------|
| Cadastro mínimo | `/register` | — | — | ⚠️ Pendente |
| Social login | `/login` | — | — | ⚠️ Pendente |
| Listagem sem localização | `/`, `/home`, `/publicacoes` | — | — | ⚠️ Pendente |
| Listagem com localização | `/`, `/home`, `/publicacoes` | — | — | ⚠️ Pendente |
| Permissão negada / localização manual | fluxo de localização | — | — | ⚠️ Pendente |
| Dropdown notificações | header global | — | — | ⚠️ Pendente |
| Chat mobile | `/chat` | — | — | ⚠️ Pendente |
| Card publicação / publicar serviço | fluxo de publicação | — | — | ⚠️ Pendente |
